...
6. Pobierz z repo https://github.com/iantrich/config-template-card/releases/tag/1.3.6 oraz https://github.com/custom-cards/decluttering-card/releases/tag/0.6.3 pliki js.
7. Używając Samba share skopiuj pliki z folderu lovelace oraz zawartość repo https://github.com/mk-maddin/dummy-HA i plik config-template-card.js:
 ...
 - config-template-card.js i decluttering-card.js do *\\\192.168.1.111\config*
...
10. W nowym dashboardzie kliknij trzy kropki u góry z prawej strony i wybierz Edit Dashboard. Ponownie kliknij w krzy kropki u góry z prawej strony i Manage resources  -> Add resource -> url: /local/config-template-card.js -> Create. Analogicznie z decluttering-card.js.
